    ...
    <div className="p-8 sm:p-10 md:p-14 rounded-3xl glow-card text-white relative overflow-hidden">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
        <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-2xl gradient-bg/10 border border-white/12 flex items-center justify-center flex-shrink-0 overflow-hidden">
          {/* avatar placeholder - swap with real image if available */}
          <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-xl bg-white/6 flex items-center justify-center">
            <svg
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="relative max-w-3xl mx-auto md:mx-0">
            {/* <span className="absolute left-0 top-0 -translate-x-3 -translate-y-6 text-6xl sm:text-7xl md:text-8xl gradient-text opacity-20 pointer-events-none select-none">
              “
            </span> */}

            <p className="text-white/95 text-2xl sm:text-lg md:text-xl leading-relaxed tracking-wide text-center md:text-left">
              {/* <span className="absolute left-0 top-0 -translate-x-3 -translate-y-6 text-5xl sm:text-3xl md:text-4xl gradient-text pointer-events-none select-none"> */}
            ...
            {/* <span className="absolute right-0 bottom-0 translate-x-3 translate-y-6 text-6xl sm:text-7xl md:text-8xl gradient-text opacity-20 pointer-events-none select-none">
              ”
            </span> */}
          </div>
